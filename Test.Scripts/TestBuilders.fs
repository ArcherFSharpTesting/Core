...
type TestBuilder =
    ...
    static member BuildTestWithTagsTestBodyTwoParameters (testFeature: IFeature<string>) =
        let monitor, (testName, tags, _), (path, fileName, fullPath, lineNumber) =
            getTestParts ()
    ...
    static member BuildTestWithTagsTestBodyOneParameter (testFeature: IFeature<string>) =
        let monitor, (testName, tags, _), (path, fileName, fullPath, lineNumber) =
            getTestParts ()
    ...
    static member BuildTestWithSetupDataTestBodyThreeParametersTeardownNameHints (testFeature: IFeature<string>, [<Optional; DefaultParameterValue(false)>] repeatDataValue: bool) =
        let monitor, (testNameRoot, testName), (_, testSetupValue, data), (path, fileName, fullPath, lineNumber) =
            getDataTestParts repeatDataValue
    ...
    static member BuildTestWithSetupDataTestBodyThreeParametersTeardown (testFeature: IFeature<string>, [<Optional; DefaultParameterValue(false)>] repeatDataValue: bool) =
    ...
    static member BuildTestWithSetupDataTestBodyTwoParametersTeardownNameHints (testFeature: IFeature<string>, [<Optional; DefaultParameterValue(false)>] repeatDataValue: bool) =
        let monitor, (testNameRoot, testName), (_, testSetupValue, data), (path, fileName, fullPath, lineNumber) =
            getDataTestParts repeatDataValue
    ...
    static member BuildTestWithSetupDataTestBodyTwoParametersTeardown (testFeature: IFeature<string>, [<Optional; DefaultParameterValue(false)>] repeatDataValue: bool) =
        let monitor, (testName, _), (_, testSetupValue, data), (path, fileName, fullPath, lineNumber) = getDataTestParts repeatDataValue
    ...
    static member BuildTestWithSetupDataTestBodyThreeParametersNameHints (testFeature: IFeature<string>, [<Optional; DefaultParameterValue(false)>] repeatDataValue: bool) =
        let monitor, (testNameRoot, testName), (_, testSetupValue, data), (path, fileName, fullPath, lineNumber) =
            getDataTestParts repeatDataValue
    ...
    static member BuildTestWithSetupDataTestBodyThreeParameters (testFeature: IFeature<string>, [<Optional; DefaultParameterValue(false)>] repeatDataValue: bool) =
        let monitor, (testName, _), (_, testSetupValue, data), (path, fileName, fullPath, lineNumber) =
            getDataTestParts repeatDataValue
    ...
    static member BuildTestWithSetupTestBodyTwoParametersTeardown (testFeature: IFeature<string>) =
        let monitor, (testName, _, testSetupValue), (path, fileName, fullPath, lineNumber) =
            getTestParts ()
    ...
    static member BuildTestWithDataTestBodyThreeParametersTeardownNameHints (testFeature: IFeature<string>, [<Optional; DefaultParameterValue(false)>] repeatDataValue: bool) =
        let monitor, (testNameRoot, testName), (_, _, data), (path, fileName, fullPath, lineNumber) =
            getDataTestParts repeatDataValue
    ...
    static member BuildTestWithDataTestBodyThreeParametersTeardown (testFeature: IFeature<string>, [<Optional; DefaultParameterValue(false)>] repeatDataValue: bool) =
        let monitor, (testName, _), (_, _, data), (path, fileName, fullPath, lineNumber) =
            getDataTestParts repeatDataValue
    ...
    static member BuildTestWithDataTestBodyTwoParametersTeardownNameHints (testFeature: IFeature<string>, [<Optional; DefaultParameterValue(false)>] repeatDataValue: bool) =
        let monitor, (testNameRoot, testName), (_, _, data), (path, fileName, fullPath, lineNumber) =
            getDataTestParts repeatDataValue
    ...
    static member BuildTestWithDataTestBodyTwoParametersTeardown (testFeature: IFeature<string>, [<Optional; DefaultParameterValue(false)>] repeatDataValue: bool) =
        let monitor, (testName, _), (_, _, data), (path, fileName, fullPath, lineNumber) =
            getDataTestParts repeatDataValue
    ...
    static member BuildTestWithDataTestBodyOneParameterTeardownNameHints (testFeature: IFeature<string>, [<Optional; DefaultParameterValue(false)>] repeatDataValue: bool) =
        let monitor, (testNameRoot, testName), (_, _, data), (path, fileName, fullPath, lineNumber) =
            getDataTestParts repeatDataValue
    ...
    static member BuildTestWithDataTestBodyOneParameterTeardown (testFeature: IFeature<string>, [<Optional; DefaultParameterValue(false)>] repeatDataValue: bool) =
        let monitor, (testName, _), (_, _, data), (path, fileName, fullPath, lineNumber) =
            getDataTestParts repeatDataValue
    ...
    static member BuildTestWithDataTestBodyThreeParametersNameHints (testFeature: IFeature<string>, [<Optional; DefaultParameterValue(false)>] repeatDataValue: bool) =
        let monitor, (testNameRoot, testName), (_, _, data), (path, fileName, fullPath, lineNumber) =
            getDataTestParts repeatDataValue
    ...
    static member BuildTestWithDataTestBodyThreeParameters (testFeature: IFeature<string>, [<Optional; DefaultParameterValue(false)>] repeatDataValue: bool) =
        let monitor, (testName, _), (_, _, data), (path, fileName, fullPath, lineNumber) =
            getDataTestParts repeatDataValue
    ...
    static member BuildTestWithDataTestBodyTwoParametersNameHints (testFeature: IFeature<string>, [<Optional; DefaultParameterValue(false)>] repeatDataValue: bool) =
        let monitor, (testNameRoot, testName), (_, _, data), (path, fileName, fullPath, lineNumber) =
            getDataTestParts repeatDataValue
    ...
    static member BuildTestWithDataTestBodyTwoParameters (testFeature: IFeature<string>, [<Optional; DefaultParameterValue(false)>] repeatDataValue: bool) =
        let monitor, (testName, _), (_, _, data), (path, fileName, fullPath, lineNumber) =
            getDataTestParts repeatDataValue
    ...
    static member BuildTestWithDataTestBodyOneParameterNameHints (testFeature: IFeature<string>, [<Optional; DefaultParameterValue(false)>] repeatDataValue: bool) =
        let monitor, (testNameRoot, testName), (_, _, data), (path, fileName, fullPath, lineNumber) =
            getDataTestParts repeatDataValue
    ...
    static member BuildTestWithDataTestBodyOneParameter (testFeature: IFeature<string>, [<Optional; DefaultParameterValue(false)>] repeatDataValue: bool) =
        let monitor, (testName, _), (_, _, data), (path, fileName, fullPath, lineNumber) =
            getDataTestParts repeatDataValue
    ...
    static member BuildTestWithTestBodyTwoParametersTearDown (testFeature: IFeature<string>) =
        let monitor, (testName, _, _), (path, fileName, fullPath, lineNumber) =
            getTestParts ()
    ...
    static member BuildTestWithTestBodyOneParameterTearDown (testFeature: IFeature<string>) =
        let monitor, (testName, _, _), (path, fileName, fullPath, lineNumber) =
            getTestParts ()
    ...
    // test body indicator
    static member BuildTestWithTestBodyTwoParameters (testFeature: IFeature<string>) =
        let monitor, (testName, _, _), (path, fileName, fullPath, lineNumber) =
            getTestParts ()
    ...
    // test function
    static member BuildTestWithTestFunctionTwoParameters (testFeature: IFeature<string>) =
        let monitor, (testName, _, _), (path, fileName, fullPath, lineNumber) =
            getTestParts ()
    ...
    static member BuildTestWithTestFunctionOneParameter (testFeature: IFeature<string>) =
        let monitor, (testName, _, _), (path, fileName, fullPath, lineNumber) =
            getTestParts ()
