module Archer.Arrows.Tests.Feature.Test.Tags.Setup.TestBodyIndicator.Teardown.``051 - Feature Test with tags, setup, test body indicator two parameters, teardown should``
...
let ``Create a valid ITest`` =
    feature.Test (fun (_, testFeature: IFeature<string>) ->
       let (_, test), (tags, _, testName), (path, fileName, lineNumber) =
           TestBuilder.BuildTestWithTagsSetupTestBodyTwoParametersTeardown testFeature
