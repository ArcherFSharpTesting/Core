module Archer.Arrows.Tests.Feature.Test.TestName.Tags.Data.TestBodyIndicator.``012 - Feature Test with test name, tags, data, test body indicator three parameters should``
