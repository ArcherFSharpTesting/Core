module Archer.Core.Tests.Feature.Test.TestName.Tags.Data.TestFunction.``015 - Feature Test with test name, tags, data, test function three parameters should``
...
let private feature = FeatureBuilder.eBuilder.eBuilder.NewFeature (
    TestTags [
        Category "Feature"
        Category "Test"
    ],
