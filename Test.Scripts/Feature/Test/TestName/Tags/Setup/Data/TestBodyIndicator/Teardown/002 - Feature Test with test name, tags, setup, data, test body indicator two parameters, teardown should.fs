module Archer.Arrows.Tests.Feature.Test.TestName.Tags.Setup.Data.TestBodyIndicator.Teardown.``002 - Feature Test with test name, tags, setup, data, test body indicator two parameters, teardown should``
...
let ``Call Test when executed`` =
    feature.Test (fun (featureSetupValue, testFeature: IFeature<string>) ->
        let (monitor, tests), (_, setupValue, data, _), _ = TestBuilder.BuildTestWithTestNameTagsSetupDataTestBodyTwoParametersTeardown testFeature
