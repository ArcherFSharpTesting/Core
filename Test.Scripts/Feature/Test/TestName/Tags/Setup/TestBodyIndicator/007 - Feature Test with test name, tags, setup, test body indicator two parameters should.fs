module Archer.Core.Tests.Feature.Test.TestName.Tags.Setup.TestBodyIndicator.``007 - Feature Test with test name, tags, setup, test body indicator two parameters should``
...
let ``Call Test when executed`` =
    feature.Test (fun (featureSetupValue, testFeature: IFeature<string>) ->
       let (monitor, test), (_, setupValue, _), _ = TestBuilder.BuildTestWithTestNameTagsSetupTestBodyTwoParameters testFeature
