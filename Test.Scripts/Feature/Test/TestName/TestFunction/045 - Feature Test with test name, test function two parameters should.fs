module Archer.Arrows.Tests.Feature.Test.TestName.TestFunction.``045 - Feature Test with test name, test function two parameters should``
...
let ``Call Test when executed`` =
    feature.Test (fun (featureSetupValue, testFeature: IFeature<string>) ->
        let (monitor, test), _, _ = TestBuilder.BuildTestWithTestNameTestFunctionTwoParameters testFeature
