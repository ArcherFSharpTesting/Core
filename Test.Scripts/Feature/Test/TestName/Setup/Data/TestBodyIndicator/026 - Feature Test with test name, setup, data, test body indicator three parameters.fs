module Archer.Core.Tests.Feature.Test.TestName.Setup.Data.TestBodyIndicator.``026 - Feature Test with test name, setup, data, test body indicator three parameters``
