module Archer.Arrows.Tests.Feature.Test.TestName.Setup.Data.TestBodyIndicator.Teardown.``025 - Feature Test with test name, setup, data, test body indicator two parameters, teardown should``
...
let ``Call setup when executed`` =
    feature.Test (fun (featureSetupValue, testFeature: IFeature<string>) ->
        let (monitor, tests), _, _ = TestBuilder.BuildTestWithTestNameSetupDataTestBodyTwoParametersTeardown testFeature
