module Archer.Arrows.Tests.Feature.Ignore.Tags.Setup.Data.``017 - Feature Ignore with tags, setup, data, test, teardown should``
...
let ``Not call setup when executed`` =
    feature.Test (fun (_, testFeature: IFeature<string>) ->
       let (monitor, tests), _, _ = IgnoreBuilder.BuildTestWithTagsSetupDataTestBodyTeardown testFeature
