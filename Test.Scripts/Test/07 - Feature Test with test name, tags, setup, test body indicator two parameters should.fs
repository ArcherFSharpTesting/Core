module Archer.Arrows.Tests.Test.``07 - Feature Test with test name, tags, setup, test body indicator two parameters should``
...
let ``Call Test when executed`` =
    feature.Test (
        Setup setupFeatureUnderTest,
        TestBody (fun (testFeature: IFeature<unit>) ->
            let (monitor, tests), _, _ = TestBuilder.BuildTestWithTestNameTagsSetupTestBodyTwoParameters testFeature
