module Archer.Arrows.Tests.Test.Tags.Setup.TestBodyIndicator.``053 - Feature Test with tags, setup, test body indicator two parameters should``
...
let ``Call Test when executed`` =
    feature.Test (fun (featureSetupValue, testFeature: IFeature<string>) ->
       let (monitor, tests), (_, setupValue, _), _ = TestBuilder.BuildTestWithTagsSetupTestBodyTwoParameters testFeature
