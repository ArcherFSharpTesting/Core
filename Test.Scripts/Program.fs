...
|> addMany [
    ...
    ``008 - Feature Ignore with test name, tags, test should``.``Test Cases``
    
    ``009 - Feature Ignore with test name, setup, data, test, teardown should``.``Test Cases``
    ...
    ``013 - Feature Ignore with test name, data, test, teardown should``.``Test Cases``
    ...
    ``017 - Feature Ignore with tags, setup, data, test, teardown should``.``Test Cases``
    ...
    ``021 - Feature Ignore with tags, data, test, teardown should``.``Test Cases``
    ...
    ``025 - Ignore Feature with setup, data, test, teardown should``.``Test Cases``
    ``026 - Ignore Feature with setup, data, test should``.``Test Cases``
    ...
    ``030 - Feature Ignore with data, test should``.``Test Cases``
    
    ``31 - Feature Ignore with test, teardown should``.``Test Cases``
